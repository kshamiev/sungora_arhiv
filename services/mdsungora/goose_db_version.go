...
func (q gooseDBVersionQuery) One(ctx context.Context, exec boil.ContextExecutor) (*GooseDBVersion, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdsungora: failed to execute a one query for goose_db_version")
	}
...
func (q gooseDBVersionQuery) All(ctx context.Context, exec boil.ContextExecutor) (GooseDBVersionSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "mdsungora: failed to assign all query results to GooseDBVersion slice")
	}
...
func (q gooseDBVersionQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: failed to count goose_db_version rows")
	}
...
func (q gooseDBVersionQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdsungora: failed to check if goose_db_version exists")
	}
...
func FindGooseDBVersion(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*GooseDBVersion, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdsungora: unable to select from goose_db_version")
	}
...
func (o *GooseDBVersion) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("mdsungora: no goose_db_version provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdsungora: unable to insert into goose_db_version")
	}
...
func (o *GooseDBVersion) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("mdsungora: unable to update goose_db_version, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to update goose_db_version row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: failed to get rows affected by update for goose_db_version")
	}
...
func (q gooseDBVersionQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to update all for goose_db_version")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to retrieve rows affected for goose_db_version")
	}
...
func (o GooseDBVersionSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to update all in gooseDBVersion slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to retrieve rows affected all in update all gooseDBVersion")
	}
	return rowsAff, nil
}
...
func (o *GooseDBVersion) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("mdsungora: no goose_db_version provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("mdsungora: unable to upsert goose_db_version, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdsungora: unable to upsert goose_db_version")
	}
...
func (o *GooseDBVersion) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("mdsungora: no GooseDBVersion provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to delete from goose_db_version")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: failed to get rows affected by delete for goose_db_version")
	}
...
func (q gooseDBVersionQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("mdsungora: no gooseDBVersionQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to delete all from goose_db_version")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: failed to get rows affected by deleteall for goose_db_version")
	}
...
func (o GooseDBVersionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to delete all from gooseDBVersion slice")
	}
...
func (o *GooseDBVersionSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdsungora: unable to reload all in GooseDBVersionSlice")
	}
...
func GooseDBVersionExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdsungora: unable to check if goose_db_version exists")
	}
