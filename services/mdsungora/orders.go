...
var (
	...
	orderColumnsWithoutDefault = []string{"status"}
	orderColumnsWithDefault    = []string{"id", "user_id", "number", "created_at", "updated_at", "deleted_at"}
...
func (q orderQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Order, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdsungora: failed to execute a one query for orders")
	}
...
func (q orderQuery) All(ctx context.Context, exec boil.ContextExecutor) (OrderSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "mdsungora: failed to assign all query results to Order slice")
	}
...
func (q orderQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: failed to count orders rows")
	}
...
func (q orderQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdsungora: failed to check if orders exists")
	}
...
func FindOrder(ctx context.Context, exec boil.ContextExecutor, iD typ.UUID, selectCols ...string) (*Order, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdsungora: unable to select from orders")
	}
...
func (o *Order) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("mdsungora: no orders provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdsungora: unable to insert into orders")
	}
...
func (o *Order) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("mdsungora: unable to update orders, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to update orders row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: failed to get rows affected by update for orders")
	}
...
func (q orderQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to update all for orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to retrieve rows affected for orders")
	}
...
func (o OrderSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to update all in order slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to retrieve rows affected all in update all order")
	}
	return rowsAff, nil
}
...
func (o *Order) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("mdsungora: no orders provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("mdsungora: unable to upsert orders, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdsungora: unable to upsert orders")
	}
...
func (o *Order) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("mdsungora: no Order provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to delete from orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: failed to get rows affected by delete for orders")
	}
...
func (q orderQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("mdsungora: no orderQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to delete all from orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: failed to get rows affected by deleteall for orders")
	}
...
func (o OrderSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mdsungora: unable to delete all from order slice")
	}
...
func (o *OrderSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdsungora: unable to reload all in OrderSlice")
	}
...
func OrderExists(ctx context.Context, exec boil.ContextExecutor, iD typ.UUID) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdsungora: unable to check if orders exists")
	}
