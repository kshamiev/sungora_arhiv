...
func (q roleQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Role, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdsample: failed to execute a one query for roles")
	}
...
func (q roleQuery) All(ctx context.Context, exec boil.ContextExecutor) (RoleSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "mdsample: failed to assign all query results to Role slice")
	}
...
func (q roleQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: failed to count roles rows")
	}
...
func (q roleQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdsample: failed to check if roles exists")
	}
...
func FindRole(ctx context.Context, exec boil.ContextExecutor, iD typ.UUID, selectCols ...string) (*Role, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdsample: unable to select from roles")
	}
...
func (o *Role) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("mdsample: no roles provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdsample: unable to insert into roles")
	}
...
func (o *Role) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("mdsample: unable to update roles, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to update roles row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: failed to get rows affected by update for roles")
	}
...
func (q roleQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to update all for roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to retrieve rows affected for roles")
	}
...
func (o RoleSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to update all in role slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to retrieve rows affected all in update all role")
	}
	return rowsAff, nil
}
...
func (o *Role) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("mdsample: no roles provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("mdsample: unable to upsert roles, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdsample: unable to upsert roles")
	}
...
func (o *Role) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("mdsample: no Role provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to delete from roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: failed to get rows affected by delete for roles")
	}
...
func (q roleQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("mdsample: no roleQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to delete all from roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: failed to get rows affected by deleteall for roles")
	}
...
func (o RoleSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to delete all from role slice")
	}
...
func (o *RoleSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdsample: unable to reload all in RoleSlice")
	}
...
func RoleExists(ctx context.Context, exec boil.ContextExecutor, iD typ.UUID) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdsample: unable to check if roles exists")
	}
