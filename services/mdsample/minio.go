...
func (q minioQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Minio, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdsample: failed to execute a one query for minio")
	}
...
func (q minioQuery) All(ctx context.Context, exec boil.ContextExecutor) (MinioSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "mdsample: failed to assign all query results to Minio slice")
	}
...
func (q minioQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: failed to count minio rows")
	}
...
func (q minioQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdsample: failed to check if minio exists")
	}
...
func FindMinio(ctx context.Context, exec boil.ContextExecutor, iD uuid.UUID, selectCols ...string) (*Minio, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdsample: unable to select from minio")
	}
...
func (o *Minio) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("mdsample: no minio provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdsample: unable to insert into minio")
	}
...
func (o *Minio) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("mdsample: unable to update minio, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to update minio row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: failed to get rows affected by update for minio")
	}
...
func (q minioQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to update all for minio")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to retrieve rows affected for minio")
	}
...
func (o MinioSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to update all in minio slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to retrieve rows affected all in update all minio")
	}
	return rowsAff, nil
}
...
func (o *Minio) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("mdsample: no minio provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("mdsample: unable to upsert minio, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdsample: unable to upsert minio")
	}
...
func (o *Minio) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("mdsample: no Minio provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to delete from minio")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: failed to get rows affected by delete for minio")
	}
...
func (q minioQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("mdsample: no minioQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to delete all from minio")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: failed to get rows affected by deleteall for minio")
	}
...
func (o MinioSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mdsample: unable to delete all from minio slice")
	}
...
func (o *MinioSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdsample: unable to reload all in MinioSlice")
	}
...
func MinioExists(ctx context.Context, exec boil.ContextExecutor, iD uuid.UUID) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdsample: unable to check if minio exists")
	}
