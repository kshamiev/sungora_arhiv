...
func (c *sampleClient) Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Test, error) {
	out := new(Test)
...
func (UnimplementedSampleServer) Ping(context.Context, *emptypb.Empty) (*Test, error) {
...
func _Sample_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SampleServer).Ping(ctx, req.(*emptypb.Empty))
	}
...
var Sample_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/pbsample/service.proto",
}
